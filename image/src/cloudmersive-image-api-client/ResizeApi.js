...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Imageapi.ResizeApi = factory(root.Imageapi.ApiClient);
  }
  ...
  /**
   * Resize service.
   * @module cloudmersive-image-api-client/ResizeApi
   * @version v1
   */

  /**
   * Constructs a new ResizeApi. 
   * @alias module:cloudmersive-image-api-client/ResizeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloudmersive-image-api-client/ResizeApi~resizePostCallback
     ...
     * @param {module:cloudmersive-image-api-client/ResizeApi~resizePostCallback} callback The callback function, accepting three arguments: error, data, response
