...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Nlpapi.CorrectWordInSentenceJsonResponse();
  });
  ...
  describe('CorrectWordInSentenceJsonResponse', function() {
    it('should create an instance of CorrectWordInSentenceJsonResponse', function() {
      ...
      //var instane = new Nlpapi.CorrectWordInSentenceJsonResponse();
      //expect(instance).to.be.a(Nlpapi.CorrectWordInSentenceJsonResponse);
    });
