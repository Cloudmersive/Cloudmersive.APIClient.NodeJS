...
(function(root, factory) {
   ...
   * @module cloudmersive-convert-api-client/ConvertTemplateApi
   * @version v1
   */

  /**
   * Constructs a new ConvertTemplateApi. 
   * @alias module:cloudmersive-convert-api-client/ConvertTemplateApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloudmersive-convert-api-client/ConvertTemplateApi~convertTemplateApplyHtmlTemplateCallback
     ...
     * @param {module:cloudmersive-convert-api-client/ConvertTemplateApi~convertTemplateApplyHtmlTemplateCallback} callback The callback function, accepting three arguments: error, data, response
