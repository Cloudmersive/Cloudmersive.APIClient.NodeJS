...
(function(root, factory) {
   ...
   * @module cloudmersive-convert-api-client/ConvertImageApi
   * @version v1
   */

  /**
   * Constructs a new ConvertImageApi. 
   * @alias module:cloudmersive-convert-api-client/ConvertImageApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloudmersive-convert-api-client/ConvertImageApi~convertImageImageFormatConvertCallback
     ...
     * @param {module:cloudmersive-convert-api-client/ConvertImageApi~convertImageImageFormatConvertCallback} callback The callback function, accepting three arguments: error, data, response
