...
(function(root, factory) {
  ...
  /**
   * ConvertWeb service.
   * @module cloudmersive-convert-api-client/ConvertWebApi
   * @version v1
   */

  /**
   * Constructs a new ConvertWebApi. 
   * @alias module:cloudmersive-convert-api-client/ConvertWebApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloudmersive-convert-api-client/ConvertWebApi~convertWebUrlToPdfCallback
     ...
     * @param {module:cloudmersive-convert-api-client/ConvertWebApi~convertWebUrlToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloudmersive-convert-api-client/ConvertWebApi~convertWebUrlToPdf_0Callback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:cloudmersive-convert-api-client/ConvertWebApi~convertWebUrlToPdf_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:cloudmersive-convert-api-client/ConvertWebApi~convertWebUrlToScreenshotCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:cloudmersive-convert-api-client/ConvertWebApi~convertWebUrlToScreenshotCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
