...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.Ocrapi);
  }
}(this, function(expect, Ocrapi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new Ocrapi.ImageToTextResponse();
  });
  ...
  describe('ImageToTextResponse', function() {
    it('should create an instance of ImageToTextResponse', function() {
      ...
      //var instane = new Ocrapi.ImageToTextResponse();
      //expect(instance).to.be.a(Ocrapi.ImageToTextResponse);
    });
