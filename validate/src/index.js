...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressGetServersResponse', 'model/AddressVerifySyntaxOnlyResponse', 'model/CheckResponse', 'model/FullEmailValidationResponse', 'model/GeolocateResponse', 'model/WhoisResponse', 'cloudmersive-validate-api-client/DomainApi', 'cloudmersive-validate-api-client/EmailApi', 'cloudmersive-validate-api-client/IPAddressApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AddressGetServersResponse'), require('./model/AddressVerifySyntaxOnlyResponse'), require('./model/CheckResponse'), require('./model/FullEmailValidationResponse'), require('./model/GeolocateResponse'), require('./model/WhoisResponse'), require('./cloudmersive-validate-api-client/DomainApi'), require('./cloudmersive-validate-api-client/EmailApi'), require('./cloudmersive-validate-api-client/IPAddressApi'));
  }
}(function(ApiClient, AddressGetServersResponse, AddressVerifySyntaxOnlyResponse, CheckResponse, FullEmailValidationResponse, GeolocateResponse, WhoisResponse, DomainApi, EmailApi, IPAddressApi) {
  'use strict';
  ...
  var exports = {
     ...
     * @property {module:cloudmersive-validate-api-client/DomainApi}
     */
    DomainApi: DomainApi,
    /**
     * The EmailApi service constructor.
     * @property {module:cloudmersive-validate-api-client/EmailApi}
     */
    EmailApi: EmailApi,
    /**
     * The IPAddressApi service constructor.
     * @property {module:cloudmersive-validate-api-client/IPAddressApi}
     */
